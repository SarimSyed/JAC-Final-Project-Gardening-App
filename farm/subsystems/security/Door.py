...
class Door(ISensor):
     ...
     def __init__(self, gpio: int, model:str = "SEC-100 Magnetic Door Sensor Reed Switch", type:SecurityReading.Type = SecurityReading.Type.DOOR):
     ...
     def read_sensor(self) -> SecurityReading:
        ...
        if(self.button.is_held == True):
               ...
               return SecurityReading(SecurityReading.Type.DOOR, {"value": door_value})
        else:
