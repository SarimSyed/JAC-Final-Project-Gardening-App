...
class Pitch(ISensor):
    ...
    def __init__(self, model: str, type: AReading.Type):
        ...
        self._accel_device = rt.get_acceleration_device()
    ...
    def read_sensor(self) -> list[AReading]:
        ...
        for event in self._accel_device.read_loop():
            ...
            if accelEvent.name != None:
                ...
                if len(x_values) >= 1 and len(y_values) >= 1 and len(z_values) >= 1:
                    ...
                    pitch = 180 * \
                        math.atan(ax / math.sqrt(ay * ay + az * az)) / math.pi
...
if __name__ == "__main__":
    ...
    pitch_sensor = Pitch("LIS3DHTR", AReading.Type.PITCH)

    while True:
        readings = pitch_sensor.read_sensor()
